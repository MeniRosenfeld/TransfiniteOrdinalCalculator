...
function compareCNF(a: any, b: any): number {
    ...
    OperationTracer.consume(minLen);
 ...
 */
export function createComparisonRules(conversionEngine: ConversionEngine): Rule[] {
    return [
        ...
        new Rule("ZetaZero equality",
            (a, b) => (a instanceof ZetaZero) && (b instanceof ZetaZero),
            (a, b) => 0),
        ...
        new Rule("ZetaZero right dominates",
            (a, b) => (b instanceof ZetaZero) && !(a instanceof ZetaZero),
            (a, b) => -1)
    ];
}
